...
const _calculateTemplateUrl = branch => {
  return `https://github.com/hsermeno/react-storefront-starter-app/zipball/${branch}`
}
 ...
 *
 * @param {string} branch The branch of react-storefront-starter-app repo to check.
 */
 ...
 *
 * @param {string} branch The branch name to checkout react-storefront-starter-app from.
